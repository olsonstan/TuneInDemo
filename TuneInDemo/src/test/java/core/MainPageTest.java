...
class MainPageTest {
    ...
    static void initialize(String browser, String url) {
        switch (browser.toLowerCase()) {
            ...
            case "firefox": {
                Logger.getLogger("").setLevel(Level.OFF);
                if (System.getProperty("os.name").toUpperCase().contains("MAC"))
                    System.setProperty("webdriver.gecko.driver", "resources/webdriver/mac/geckodriver");
                else if (System.getProperty("os.name").toUpperCase().contains("WINDOWS"))
    ...
    static boolean colorMatch (String actualColor, String expectedColorFormatOne, String expectedColorFormatTwo, String expectedColorFormatThree) {
         if(actualColor.equals(expectedColorFormatOne) || actualColor.equals(expectedColorFormatTwo) || actualColor.equals(expectedColorFormatThree)) return true; return false; }
    ...
    public static void main(String[] args) throws Exception {
        initialize(args[0], "https://tunein.com/?homecarouselautoscroll=false");
        ...
        System.out.printf("\n\nTC-01.02.01: %s", (colorMatch(getElementColor(textLineOne),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.02: %s", (colorMatch(getElementColor(textLineTwo),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.03: %s", (colorMatch(getElementColor(textLineThree),"rgb(28, 32, 60)","rgba(28, 32, 60, 1)","#1c203c")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.04: %s", (colorMatch(getElementColor(textLineFour),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.05: %s", (colorMatch(getElementColor(textLineFive),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.06: %s", (colorMatch(getElementColor(textLineSix),"rgb(28, 32, 60)","rgba(28, 32, 60, 1)","#1c203c")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.07: %s", (colorMatch(getElementColor(textLineSeven),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.08: %s", (colorMatch(getElementColor(textLineEight),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.09: %s", (colorMatch(getElementColor(textLineNine),"rgb(28, 32, 60)","rgba(28, 32, 60, 1)","#1c203c")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.10: %s", (colorMatch(getElementColor(textLineTen),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.11: %s", (colorMatch(getElementColor(textLineEleven),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.12: %s", (colorMatch(getElementColor(textLineTwelfth),"rgb(28, 32, 60)","rgba(28, 32, 60, 1)","#1c203c")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.13: %s", (colorMatch(getElementColor(textLineThirteen),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.14: %s", (colorMatch(getElementColor(textLineFourteen),"rgb(255, 255, 255)","rgba(255, 255, 255, 1)","#fff")?"Passed":"Failed : Font color mismatch"));
        System.out.printf("\nTC-01.02.15: %s", (colorMatch(getElementColor(textLineFifteen),"rgb(28, 32, 60)","rgba(28, 32, 60, 1)","#1c203c")?"Passed":"Failed : Font color mismatch"));
